<template>
  <section
    ...
    :style="
      logged
        ? ''
        : 'min-width:100%;background-image: url(' +
          backurl +
          ');background-size:cover;min-width:100%;box-shadow:inset 0 0 0 2000px rgba(0, 0, 0, 0.5);'
    "
  >
    ...
    <div
      :class="
        ismobile
          ? 'columns is-mobile is-centered mx-0 px-0'
          : 'columns is-mobile is-centered mx-0 px-0 '
      "
    >
      <div class="column is-full mx-0 px-0">
        ...
        >
          <transition name="slide-fade" mode="out-in">
            ...
            >
              <section
                :class="
                  ismobile
                    ? 'hero is-fullheight mx-0 px-0'
                    : 'hero is-large mx-0 px-0'
                "
                :style="
                  ismobile
                    ? 'background: center;background-image: url(' +
                      mainhero.poster +
                      ');background-size:cover;min-width:100%;box-shadow:inset 0 0 0 2000px rgba(0, 0, 0, 0.2);'
                ...
                <div class="hero-body">
                  <div class="container">
                    <div class="columns is-mobile is-vcentered is-multiline">
                      <div
                        :class="ismobile ? 'column is-full' : 'column-is-half'"
                      >
                        <h2 class="subtitle has-text-white">
                          {{ mainhero.subtitle }}
                        </h2>
                        <h1
                          class="title main-home-hero-title has-text-white is-1"
                        >
                          {{ mainhero.title }}
                        </h1>
                        <h3 class="subtitle has-text-white">Watch Here</h3>
                        <v-btn
                          class="is-netflix-red"
                          @click="gotoPage('/' + mainhero.link + '/')"
                        >
                          <span class="icon">
          ...
          <div
            ...
            :class="
              ismobile
                ? 'column is-full mt-2 mr-0'
                : 'column is-full ml-2 mr-0 pl-4 pr-0'
            "
          >
        ...
        >
          <div class="column is-two-thirds has-text-centered">
            <h2 class="subtitle has-text-white has-text-weight-bold">
              {{
                load
                  ? 'Please Wait While Links are Being Retrieved'
                  : 'You havent Setted up any Quicklinks. Setup that from Admin Panel.'
              }}
            </h2>
            <button
              v-if="!load"
              class="button is-netflix-red"
              @click="gotoPage('/')"
            >
              Go to Drive
            </button>
        ...
        <section
          v-show="!logged"
          :class="ismobile ? 'hero is-fullheight px-0' : 'hero is-fullheight'"
        >
          <div class="hero-body">
            <div
              :class="
                ismobile
                  ? 'container has-text-white is-fluid px-0'
                  : 'container has-text-white is-fluid'
              "
            >
              <h1
                :class="
                  ismobile
                    ? 'title has-text-white has-text-centered'
                    : 'title is-1 has-text-white has-text-centered'
                "
              >
                <div
                ...
                >
                  ...
                  <div :class="ismobile ? 'column is-full' : 'column is-full'">
                    <h1
                      :class="
                        ismobile
                          ? 'title is-small has-text-white has-text-centered'
                          : 'title has-text-white has-text-centered'
                      "
                    >
                      Get Started Now !
              ...
              <form @submit.prevent="verifyEmail">
                ...
                >
                  <div class="column is-two-thirds">
                    <div
                      class="columns is-multiline is-centered is-gapless is-vcentered"
                    >
                          ...
                          <div class="control">
                            <button
                              :class="
                                ismobile
                                  ? loading
                                    ? 'button is-loading is-rounded is-success'
                                    : 'button is-rounded is-success'
                                  : loading
                                  ? 'button is-rounded is-loading is-large is-success'
                                  : 'button is-large is-rounded is-success'
                              "
                              :disabled="disabled"
                            >
                              <span>Start</span>
                  ...
                  <div class="column mx-0 px-0 is-two-thirds">
                    <p
                      class="has-text-weight-normal has-text-white subtitle has-text-centered title is-6"
                    >
                      Enter Your Email to Login / Request / Register.
                    </p>
                  </div>
                  <div
                    class="column is-full mb-0 mt-4 mx-0 px-0 has-text-centered"
                  >
                    <p
                      class="subtitle has-text-netflix-only has-text-weight-bold has-text-centered"
                    >
            ...
            if (
              ...
              this.$router.push({
                ...
                params: {
                  ...
                  success: true,
                  data:
                    'You Are Currently Pending Confirmation from Admins. Please Wait till they Accept Your Request.',
                },
              });
            } else if (
              !response.data.auth &&
              ...
              this.$router.push({
                ...
                params: {
                  ...
                  success: false,
                  data:
                    'You are being Added to Our Spam List for Violations. Please Contact Admins for Help.',
                },
              });
            } else {
              this.loading = false;
              ...
              this.$router.push({
                ...
                params: {
                  ...
                  success: false,
                  data:
                    "There's Some Error With Your Network. Please Try Again Later.",
                },
              });
            }
          })
