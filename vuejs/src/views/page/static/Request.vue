                ...
                <label for="terms">
                  <span class="content has-text-white">
                    ...
                    <a
                      ...
                      href="https://cdn.jsdelivr.net/gh/jusidama18/gindex-v4@frontend-8.3.1/CONTRIBUTING.md"
                      target="_blank"
              ...
              <div class="b-checkbox is-success is-circular is-inline">
                ...
                <label for="code">
                  <span class="content has-text-white">
                    ...
                    <a
                      class="has-text-success"
                      href="https://cdn.jsdelivr.net/gh/jusidama18/gindex-v4@frontend-8.3.1/CODE_OF_CONDUCT.md"
                      target="_blank"
                      >Code of Conduct</a
                    ></span
                  >
            ...
            <div class="container">
              <div class="tile is-ancestor">
                <div class="tile is-parent">
                  <article
                    class="tile has-text-centered is-child notification is-warning"
                  >
                    ...
                    <div class="content">
                      <p class="has-text-dark has-text-weight-semibold">
                        You have to Request Before Continuing in the Website.
                      </p>
                      <p class="has-text-dark">
                        When our Admins Accept your Request, You will Receive an
                        Email Containing an OTP to Register your Account and
                        Verify.
                      </p>
                    </div>
                  </article>
